namespace Goldbach
{
    partial class frmMain
    {
        ...
        /// </summary>
        /// <param name="disposing">如果应释放托管资源，为 true；否则为 false。(true if managed resources should be disposed; otherwise, false)</param>
        ...
        #region Windows 窗体设计器生成的代码 (Windows Form Designer generated code)
